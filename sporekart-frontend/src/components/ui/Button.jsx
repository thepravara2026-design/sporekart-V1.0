...
export default function Button({
  ...
  const variants = {
    primary: "bg-[#234D3C] hover:bg-[#1B3D30] active:bg-[#153127] text-white focus:ring-[#234D3C]/40 shadow-sm hover:shadow-md",
    ...
    destructive: "bg-[#C44747] hover:bg-[#A83B3B] active:bg-[#8E3232] text-white focus:ring-[#C44747]/40 shadow-sm",
  };
